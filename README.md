These Python scripts are used for the Simulations of ORAID architecture.

1).  simulated_MTTDL.py  - generates simluated MTTDL for increasing constellation sizes
